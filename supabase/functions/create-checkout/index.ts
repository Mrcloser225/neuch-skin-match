...
serve(async (req) => {
  ...
  try {
    ...
    logStep("Determined pricing", { priceAmount, interval });
      ...
      line_items: [
        {
          price_data: {
            currency: "usd",
            product_data: { 
              name: planId === "premium-monthly" ? "Premium Monthly" : "Premium Yearly",
              description: "Foundation matching premium subscription"
            },
